...
public class Triangle {
    ...
    public Triangle() {
        ...
        Segment bc = new Segment();
        Segment ca = new Segment();
    }

    public Triangle(Point a) {
        this.a = a;
        this.b = new Point(0, 0);
        this.c = new Point(0, 2);
    ...
    public void input() {
        ...
        Point b = new Point();
        Point c = new Point();
        System.out.println("Enter the coordinates of the point A:");
        a.input();
        System.out.println("Enter the coordinates of the point B:");
        b.input();
        System.out.println("Enter the coordinates of the point C:");
        c.input();
    ...
    public void output() {
        System.out.println("The coordinates of the point A: ");
        this.a.output();
        System.out.println("The coordinates of the point B: ");
        this.b.output();
        System.out.println("The coordinates of the point C: ");
        this.c.output();
        System.out.println("AB length is " + this.ab.get_length());
        System.out.println("BC length is " + this.bc.get_length());
        System.out.println("CA length is " + this.ca.get_length());
        System.out.println("Triangle perimeter is " + this.triangle_perimeter());
        System.out.println("Triangle area is " + this.triangle_area());
    }
